...
The [v0.37.0 release](https://github.com/intel/intel-device-plugins-for-kubernetes/releases/latest)
is the latest feature release with its documentation available [here](https://intel.github.io/intel-device-plugins-for-kubernetes/0.37/).
...
The [Device plugins Operator for OpenShift](OPENSHIFT.md) gives the installation and usage details for the operator available on [Red Hat OpenShift Container Platform](https://catalog.redhat.com/software/operators/detail/61e9f2d7b9cdd99018fc5736).
...
|:------------------|:---------------------|:------------|
| release-0.37      | Kubernetes 1.37      | supported   |
| release-0.36      | Kubernetes 1.36      | supported   |
| release-0.35      | Kubernetes 1.35      | supported   |
| release-0.34      | Kubernetes 1.33-1.34 | unsupported |
