...
var sgxDefaultImage = "intel/intel-sgx-plugin:" + controllers.ImageMinVersion.String()
var sgxValidatorConfig = &validatorConfig{
...
func (r *SgxDevicePlugin) validatePlugin(ref *validatorConfig) error {
