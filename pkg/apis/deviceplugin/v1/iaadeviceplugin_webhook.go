...
var iaaDefaultImage = "intel/intel-iaa-plugin:" + controllers.ImageMinVersion.String()
var iaaValidatorConfig = &validatorConfig{
...
func (r *IaaDevicePlugin) validatePlugin(ref *validatorConfig) error {
