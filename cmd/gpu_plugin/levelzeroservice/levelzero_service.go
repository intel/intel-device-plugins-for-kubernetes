...
type LevelzeroService interface {
	...
	GetDeviceHealth(bdfAddress string) (bool, bool, error)
...
func (l *levelzero) GetDeviceHealth(bdfAddress string) (bool, bool, error) {
	if !l.isClientReady() {
		return true, true, &clientNotReadyErr{}
	}
	...
	return health.MemoryOk, health.BusOk, nil
}
