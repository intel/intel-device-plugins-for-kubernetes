	...
	tcases := []struct {
		...
		},
		{
			...
			options: cliOptions{
				...
				preferredAllocationPolicy: "none",
				monitoringMode:            "single",
				xpumdUnhealthySeverity:    "critical",
			},
			expectErrStr: "",
		},
		{
		...
		{
			name: "xpumd invalid health severity",
			options: cliOptions{
				allowIDs:                  "",
				denyIDs:                   "",
				sharedDevNum:              1,
				...
				healthManagement:          false,
				xpumdEndpoint:             "/foo/bar/socket.sock",
				xpumdUnhealthySeverity:    "foobar",
				globalTempLimit:           100,
				memoryTempLimit:           100,
				gpuTempLimit:              100,
			},
			expectErrStr: "invalid value for xpumd-unhealthy-severity, valid values: failed, critical, warning",
		},
		{
			name: "wsl",
			options: cliOptions{
