...
LABEL org.opencontainers.image.title='Intel® IAA device plugin for Kubernetes'
LABEL org.opencontainers.image.description='The IAA device plugin supports acceleration using the Intel Analytics accelerator(IAA)'
